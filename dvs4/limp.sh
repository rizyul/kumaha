...
clear
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/julakhss/julakhss/main/JB4/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/julakhss/julakhss/main/JB4/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
