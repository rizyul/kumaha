...
wget -O /usr/bin/edu-proxy https://raw.githubusercontent.com/julakhss/julakhss/main/JB1/openssh.py
wget -O /usr/bin/ws-dropbear https://raw.githubusercontent.com/julakhss/julakhss/main/JB1/dropbear-ws.py
wget -O /usr/bin/ws-stunnel https://raw.githubusercontent.com/julakhss/julakhss/main/JB1/ws-stunnel.txt
wget -O /usr/bin/ws-ovpn https://raw.githubusercontent.com/julakhss/julakhss/main/JB1/ovpn.py
